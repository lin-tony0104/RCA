...
if len(sys.argv)>=2:
    ...
    print("EX: python TypeAu.py 05_wikI_LRU_seg0 05_wikI_LRU_seg1 05_wikI_LRU_seg2 05_wikI_LRU_seg3 05_wikI_LRU_seg4 05_wikI_LRU_seg5 05_wikI_LRU_seg6 05_wikI_LRU_seg7 05_wikI_LRU_seg8 05_wikI_LRU_seg9")
    sys.exit()
# exp_name = "exampleLRU"
