...
if len(sys.argv)==3:
    ...
    print("EX: python show_result_diff.py 05_wiki_RCA_seg0 05_wiki_RCA-aging_seg0")
    sys.exit()
# exp_name = "exampleLRU"
...
#==============diff===============  
policy_name1 = exp_names[0].split("_")[2]
policy_name2 = exp_names[1].split("_")[2]
diff_name = f"{policy_name1} - {policy_name2} "
